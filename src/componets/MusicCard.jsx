...
const MusicCard = () => {
  const trackCensoredName = "Partition";
  const artistName = "Beyonce";
  const collectionName = "BEYONCE";
  return (
    <Card style={{ width: "18rem" }}>
      ...
      />
      <Card.Body>
        <Card.Title>{trackCensoredName}</Card.Title>
        <Card.Text>{`${artistName} - ${collectionName}`}</Card.Text>
        <Button variant="primary">View Track</Button>
      </Card.Body>
    </Card>
  );
};
